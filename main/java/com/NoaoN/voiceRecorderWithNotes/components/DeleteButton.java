...
/**
 * I've had some issues clicking on buttons in the recordings list and notes, so I've
 * created this class to manage the click event.
 */
public class DeleteButton extends android.support.v7.widget.AppCompatButton {
